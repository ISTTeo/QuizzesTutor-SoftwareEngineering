...
@DataJpaTest
class GetDiscussionQuestionServiceSpockTest extends Specification {
    ...
    def "create a a question and a discussion associated with it and check"() {
        given: "a student"
        ...
        def result = discussionService.getDiscussionQuestion(discussion.getId())
