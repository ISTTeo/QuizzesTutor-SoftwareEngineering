...
public class QuestionDto implements Serializable {
    ...
    public QuestionDto(Question question) {
        ...
        if (!question.getQuizQuestions().isEmpty()) {
            this.numberOfGeneratedQuizzes = (int) question.getQuizQuestions().stream().map(QuizQuestion::getQuiz)
                    .filter(quiz -> quiz.getType().equals(Quiz.QuizType.GENERATED)).count();
        }
    ...
    public String toString() {
        return "QuestionDto{" + "id=" + id + ", key=" + key + ", title='" + title + '\'' + ", content='" + content
                + '\'' + ", difficulty=" + difficulty + ", numberOfAnswers=" + numberOfAnswers
                + ", numberOfGeneratedQuizzes=" + numberOfGeneratedQuizzes + ", numberOfNonGeneratedQuizzes="
                + numberOfNonGeneratedQuizzes + ", numberOfCorrect=" + numberOfCorrect + ", creationDate='"
                + creationDate + '\'' + ", status='" + status + '\'' + ", options=" + options + ", image=" + image
                + ", topics=" + topics + ", sequence=" + sequence + '}';
    }
}
