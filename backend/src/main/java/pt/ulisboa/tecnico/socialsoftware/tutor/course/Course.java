...
public class Course implements DomainEntity {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "course", fetch=FetchType.LAZY, orphanRemoval=true)
    private final Set<QuestionProposal> questionProposals = new HashSet<>();
    ...
    public void addQuestionProposal(QuestionProposal questionProposal) {
        questionProposals.add(questionProposal);
    }
