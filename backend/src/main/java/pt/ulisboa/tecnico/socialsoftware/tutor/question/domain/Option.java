...
public class Option implements DomainEntity {
    ...
    @ManyToOne(fetch=FetchType.LAZY)
    @JoinColumn(name = "questionProposal_id")
    ...
    public void setQuestionProposal(QuestionProposal questionProposal) {
        this.questionProposal = questionProposal;
        assert this.content != null;
        questionProposal.addOption(this);
    }
