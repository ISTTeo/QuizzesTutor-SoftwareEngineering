    ...
    <v-app-bar color="primary" clipped-left>
      ...
      <v-toolbar-items class="hidden-sm-and-down" hide-details>
        ...
        <v-menu offset-y v-if="isTeacher && currentCourse" open-on-hover>
          <template v-slot:activator="{ on }">
            <v-btn data-cy="managementButton" v-on="on" text dark>
              Management
              <v-icon>fas fa-file-alt</v-icon>
            </v-btn>
          </template>
          <v-list dense>
            ...
            <v-list-item to="/management/proposals">
              <v-list-item-action>
                <v-icon>question_answer</v-icon>
              </v-list-item-action>
              <v-list-item-content>
        ...
        <v-menu offset-y v-if="isStudent && currentCourse" open-on-hover>
          ...
          <v-list dense>
            ...
            <v-list-item to="/student/tournaments/create">
              ...
              <v-list-item-content>
                <v-list-item-title>Create Tournament</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item to="/student/tournaments/ongoing">
              <v-list-item-action>
                <v-icon>mdi-clock</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>Ongoing Tournaments</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item to="/student/tournaments/finished">
              <v-list-item-action>
                <v-icon>mdi-clipboard-check</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>Finished Tournaments</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-list>
        </v-menu>
        ...
        <v-menu offset-y v-if="isStudent && currentCourse" open-on-hover>
          ...
          <v-list dense>
            <v-list-item to="/student/CreateQuestionProposal">
              <v-list-item-action>
                <v-icon>create</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>Create Question Proposal</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
            <v-list-item to="/student/ViewQuestionProposals">
              <v-list-item-action>
                <v-icon>far fa-list-alt</v-icon>
              </v-list-item-action>
              <v-list-item-content>
                <v-list-item-title>View Question Proposals</v-list-item-title>
              </v-list-item-content>
            </v-list-item>
          </v-list>
        </v-menu>
        ...
        <v-btn data-cy="dashboardButton" to="/student/dashboard" v-if="isStudent && currentCourse" text dark>
          Dashboard
          <v-icon>fas fa-user</v-icon>
        </v-btn>
        ...
        <v-btn v-if="isLoggedIn" @click="logout" data-cy="logoutButton" text dark>
          Logout
      ...
      <v-list class="pt-0" dense>
        ...
        >
          ...
          <v-list-item to="/student/ViewQuestionProposals">
            ...
            <v-list-item-content>Question Proposals</v-list-item-content>
          </v-list-item>
          ...
          <v-list-item to="/tournaments/create">
            <v-list-item-action>
              <v-icon>create</v-icon>
            </v-list-item-action>
